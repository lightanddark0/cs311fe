...
import { Upload, FileText, CheckCircle, XCircle, ArrowRight, File } from 'lucide-react'
...
const UploadPage = () => {
  ...
  const handleJdUpload = async () => {
    ...
    try {
      ...
      setJdError(error.message || 'Failed to extract job description. Please try again.')
      setJdStatus('error')
    } finally {
  ...
  const handleStartInterview = () => {
    ...
    navigate('/interview', { state: { sessionId, cvData, jdData } })
  }
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <span style={{ fontSize: '24px', fontWeight: 'bold', color: '#111827' }}>InterviewAI</span>
            </div>
            ...
            <nav style={{ 
              ...
              <a href="/upload" style={{ color: '#3b82f6', fontWeight: '500', textDecoration: 'none' }}>Upload</a>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
          ...
          <div className="card" style={{ padding: '32px' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{
                ...
                <label htmlFor="cv-upload" style={{ cursor: 'pointer' }}>
                  {cvFile ? (
                    <div>
                      <File size={48} color="#3b82f6" style={{ marginBottom: '12px' }} />
                      <p style={{ color: '#3b82f6', fontWeight: '600' }}>{cvFile.name}</p>
            ...
            {cvError && (
              <div style={{
                ...
                <p style={{ color: '#dc2626', fontSize: '0.875rem', margin: 0 }}>{cvError}</p>
              </div>
            )}
          ...
          <div className="card" style={{ padding: '32px' }}>
            ...
            {jdError && (
              <div style={{
                ...
                <XCircle size={20} color="#dc2626" />
                <p style={{ color: '#dc2626', fontSize: '0.875rem', margin: 0 }}>{jdError}</p>
              </div>
            )}
            ...
            <button
              ...
              style={{
                width: '100%',
                background: jdText.trim() && !jdUploading
                ...
                borderRadius: '8px',
                fontWeight: '600',
                cursor: jdText.trim() && !jdUploading ? 'pointer' : 'not-allowed',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                gap: '8px',
        ...
        <div style={{ textAlign: 'center', marginTop: '48px' }}>
          <button
            ...
            disabled={!cvStatus || !jdStatus}
            style={{
              background: cvStatus === 'success' && jdStatus === 'success'
                ? 'linear-gradient(135deg, #3b82f6, #8b5cf6)'
                : '#e5e7eb',
              color: cvStatus === 'success' && jdStatus === 'success' ? 'white' : '#9ca3af',
              border: 'none',
              padding: '18px 48px',
              borderRadius: '12px',
              fontWeight: '700',
              fontSize: '1.125rem',
              cursor: cvStatus === 'success' && jdStatus === 'success' ? 'pointer' : 'not-allowed',
              display: 'inline-flex',
              alignItems: 'center',
              gap: '12px',
              transition: 'all 0.2s',
              boxShadow: cvStatus === 'success' && jdStatus === 'success'
