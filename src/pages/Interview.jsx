...
const Interview = () => {
  ...
  const sendMessage = async (messageText = inputMessage) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, errorMessage])
      speak("Sorry, I'm having trouble connecting to my brain right now. Please try again later.");
    } finally {
      setIsTyping(false)
    }
  }
  ...
  const handleMouseMove = (e) => {
    if (isResizing.current) {
      ...
      if (newWidth > 300 && newWidth < window.innerWidth * 0.7) { // Min and Max width constraints
